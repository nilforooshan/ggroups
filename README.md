[![R-CMD-check](https://github.com/nilforooshan/ggroups/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/nilforooshan/ggroups/actions/workflows/R-CMD-check.yaml)
